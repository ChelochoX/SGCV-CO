...
Public Class DSH_LISTADO_ATRASOS_HASTA_60
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "DSH_LISTADO_ATRASOS_HASTA_60.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SGCV_CO_V1._0.DSH_LISTADO_ATRASOS_HASTA_60.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDSH_LISTADO_ATRASOS_HASTA_60
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DSH_LISTADO_ATRASOS_HASTA_60 = New DSH_LISTADO_ATRASOS_HASTA_60()
        rpt.Site = Me.Site
        Return rpt
    End Function
