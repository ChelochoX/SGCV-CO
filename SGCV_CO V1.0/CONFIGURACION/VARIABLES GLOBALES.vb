...
Module VARIABLES_GLOBALES
    ...
    'DATOS PARA RELACIONAR TITULAR CON GARANTE
    Public Datos_TitularGarante As String

    'PARA MOSTRAR FACTURACIONES DESDE CUENTA CLIENTE
    Public identificador_desdeCuentaCliente As Integer
    Public Num_CabeceraCuenta_ As String
