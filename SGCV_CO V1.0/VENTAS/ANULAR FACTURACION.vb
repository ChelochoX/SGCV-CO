...
Public Class ANULAR_FACTURACION
    ...
    Function CodparaAnular(ByVal A As String) As Integer
        Try
            conectar()
            Dim sel As String
            sel = "SELECT COD_FACTURA FROM VF_CABECERA_FACTURA WHERE NUMERO_FACTURA = '" & A & "' "
    ...
    Private Sub btnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        ...
        Else
            ...
            'ELIMINAMOS LA CUENTA DEL CLIENTE
             Try
                conectar()
                Dim sel As String
            ...
            'ELIMINAMOS VALOR DE LA CAJA
             If paraTipoFactura = "CONTADO" Then
                ...
                End Try
            End If
            'ELIMINAMOS DE LA TABLA INFORME DE VENDEDORES
            Try
                conectar()
                Dim sel As String
                sel = "DELETE FROM INF_VENTA_POR_VENDEDOR " & _
            ...
            Dim cantidad_D, cantidad_S, codigo_factura, CodAnular As Integer
            deposito = paraDepositoNom(deposito_)
            CodAnular = CodparaAnular(valor)
            ...
            For i = 0 To Me.BindingContext(Me.DsDetalle, "VF_DETALLE_FACTURA").Count - 1
                ...
                codigo_factura = CInt(Me.DsDetalle.Tables("VF_DETALLE_FACTURA").Rows(Me.BindingContext(Me.DsDetalle, "VF_DETALLE_FACTURA").Position).Item("COD_FACTURA").ToString)
                ...
                If CodAnular = codigo_factura Then
