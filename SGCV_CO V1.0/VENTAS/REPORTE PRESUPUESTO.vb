...
Public Class REPORTE_PRESUPUESTO
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "REPORTE PRESUPUESTO.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SGCV_CO_V1._0.REPORTE PRESUPUESTO.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_NUMERO_PRESUPUESTO() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedREPORTE_PRESUPUESTO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As REPORTE_PRESUPUESTO = New REPORTE_PRESUPUESTO()
        rpt.Site = Me.Site
        Return rpt
    End Function
