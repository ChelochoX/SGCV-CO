...
Public Class DETALLES_DE_CAJA
    ...
    Private Sub DETALLES_DE_CAJA_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Caja_Habilitada("HABILITADO") = 0 Then
            Me.btnEstadoCaja.Text = "ESTADO DE CAJA INHABILITADA"
        ...
        Else
            ...
            If FECHA_ULTIMO_APERTURA < Today Then
                ...
                Me.btnEstadoCaja.BackColor = Color.LightGreen
    ...
    Private Sub btnImprimir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnImprimir.Click
        If Caja_Habilitada("HABILITADO") = 0 Then
            MessageBox.Show("Caja Inhabilitada, realizar apertura para imprimir!", "SGCV_CO VERSION EXTENDIDA", MessageBoxButtons.OK, MessageBoxIcon.Information)
        Else
            valor = Today
